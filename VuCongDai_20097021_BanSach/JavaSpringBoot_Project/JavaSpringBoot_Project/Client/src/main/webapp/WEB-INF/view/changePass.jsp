...
<html>
    ...
    <body>
        ...
        <div class="col-md-12">
            <h1 class="margin-bottom-15">Đổi Mật Khẩu</h1>
            <form:form action="/Client/profile/updatePass" modelAttribute="ItemAccount" class="form-horizontal templatemo-container templatemo-login-form-1 margin-bottom-30" role="form" method="POST">				
                <div class="form-group">
                    <div class="col-xs-12">		            
                        <div class="control-wrapper">
                            <label for="passwordOld" class="control-label fa-label"><i class="fas fa-unlock"></i></label>
                            <form:input path="username" type="password" class="form-control" id="username" placeholder="Mật khẩu cũ"/>
                        </div>		            	            
                    </div>              
                </div>
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="control-wrapper">
                            <label for="passwordNew" class="control-label fa-label"><i class="fa fa-lock fa-medium"></i></label>
                            <form:input path="password1" type="password" class="form-control" id="password" placeholder="Mật khẩu mới"/>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="control-wrapper">
                            <label for="passwordNew" class="control-label fa-label"><i class="fas fa-key"></i></label>
                            <form:input path="password2" type="password" class="form-control" id="password" placeholder="Nhập lại mật khẩu mới"/>
                        </div>
                    </div>
                </div>
                <div class="form-group">
